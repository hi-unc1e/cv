---
title: "HackTheBox: OpenAdmin Notes"
slug: de9d6z
translationKey: de9d6z
...
I then found another exploit script at [https://github.com/amriunix/ona-rce](https://github.com/amriunix/ona-rce), which ran successfully with `www-data` privileges, but without permission to read the `flag`:
